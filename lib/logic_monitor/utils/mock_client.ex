defmodule LogicMonitor.MockClient do
  ...
  def get("https://test.logicmonitor.com/santaba/rest/headers/test?a=b&c=d",
    ...
    %HTTPotion.Response{body: "{\"status\":200, \"data\":{\"total\": 2, \"items\": [\"opts\", \"success\"]}}", headers: "Some Headers"}
  end
  def get("https://test.logicmonitor.com/santaba/rest/success/success?a=b&c=d", _), do: %HTTPotion.Response{body: "{\"status\":200, \"data\":{\"total\": 2, \"items\": [\"opts\", \"success\"]}}", headers: "Some Headers"}
  ...
  def get("https://test.logicmonitor.com/santaba/rest/alert/alerts?sort=this_way&fields=a,b,c&", _) do
    %HTTPotion.Response{body: "{\"status\":200, \"data\": {\"total\": 2, \"items\": [{}, {}]}}", headers: "Some Headers"}
  end
